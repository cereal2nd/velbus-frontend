...
module.exports.sourceMapURL = () => {
  ...
  return `https://raw.githubusercontent.com/Cereal2nd/velbus-frontend/${ref}/`;
};
...
module.exports.config = {
  velbus({ isProdBuild, latestBuild }) {
    return {
      entry: {
        "velbus-panel": path.resolve(paths.velbus_dir, "src/entrypoint.ts"),
      },
      outputPath: paths.velbus_output_root,
      publicPath: `${paths.velbus_publicPath}/`,
      isProdBuild,
      latestBuild,
      dontHash: new Set(["velbus-panel"]),
    };
  },
};
